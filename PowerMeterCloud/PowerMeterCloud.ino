...
void wifireset() {
  if(wifistat == 0) {
    ...
    display.clearDisplay();
    display.setTextSize(1); display.setTextColor(SSD1306_WHITE);
    display.setCursor(6, 15); display.print("WiFi Configured!");
    //display.setCursor(20, 25); display.println("WiFi Manager");
    //display.setCursor(8, 35); display.println("Not Available");
    display.setCursor(8, 35); display.println(SSID);
    display.display();
    delay(3000);
  }
}
